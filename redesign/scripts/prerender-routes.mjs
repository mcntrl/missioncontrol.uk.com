...
const servicePages = [
  {
    ...
    title: "Custom App Development Company — Mission Control",
    ...
    heading: "Custom mobile, web and desktop app development",
  ...
  },
  {
    ...
    title: "Mobile App Development Company UK — Mission Control",
    ...
    copy: "Our mobile work spans healthcare, accessibility, learning, mobility, retail and consumer products. Each product connects accessible experience design with iOS and Android engineering, secure services, app-store delivery, monitoring and long-term support.",
  },
  {
    route: "/ios-app-development",
    title: "iOS App Development Company UK — Mission Control",
    ...
    copy: "We build iPhone and iPad products involving accessible interfaces, accounts, payments, video, notifications, content and native device features. Previous Apple-platform work includes NHS condition apps, ClickBSL and BikeAway NFC access.",
  },
  {
    route: "/android-app-development",
    title: "Android App Development Company UK — Mission Control",
    ...
    copy: "Mission Control designs Android products for varied devices, environments and operating conditions. Our work covers product definition, accessible experience design, native or cross-platform engineering, integrations, Google Play release and support.",
  },
  {
    route: "/web-app-development",
    title: "Web App Development Company UK — Mission Control",
    ...
    copy: "Our web application experience includes high-traffic publishing, customer accounts, learning products, booking and payment systems, content management, reporting and complex data integrations. Oxford dictionary platforms have handled peaks of 20,000 requests per minute.",
  },
  {
    route: "/ai-app-development",
    title: "AI App Development Company UK — Mission Control",
    ...
    copy: "We combine applied machine learning with mobile and web product engineering, including experience design, data planning, evaluation, security, privacy and monitored operation. Mars ForPaws achieved more than 96 percent matching accuracy across more than 130 dog breeds.",
  },
  {
    route: "/app-development-cost",
    title: "App Development Cost Guide — Mission Control",
    ...
    heading: "How much does app development cost?",
    copy: "A responsible estimate starts with the product outcome, essential journeys, required platforms, integrations, assurance needs and operating plan. Mission Control turns those decisions into explicit assumptions, a phased roadmap and a credible next step.",
    schemaType: "Article",
  },
  {
    route: "/ai-agent",
  ...
  },
  {
    ...
    title: "App Design & Prototyping Company — Mission Control",
    ...
    heading: "App design, product strategy and prototyping",
...
for (const service of servicePages) {
  currentPages[service.route] = {
    ...
    article: service.schemaType === "Article",
